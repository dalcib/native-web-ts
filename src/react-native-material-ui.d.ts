...
// https://github.com/DefinitelyTyped/DefinitelyTyped/pull/18290
...
declare module 'react-native-material-ui' {
  ...
  interface IBottomNavigationAction {
    key?: string
    icon: any //JSX.Element | string
    label?: string
    active?: boolean
    onPress?: () => void
    style?: {
  ...
  export class Subheader extends Component<ISubheader, any> {}
  export class Badge extends Component<IBadge, any> {}
  export class Icon extends Component<IIcon, any> {}
  export class BottomNavigation extends Component<IBottomNavigation, any> {}
  export namespace BottomNavigation {
    export class Action extends Component<IBottomNavigationAction, any> {}
  }
  ...
  export namespace COLOR {
    ...
    export const blackPrimary: 'rgba(0, 0, 0, 0.87)'
    export const blackSecondary: 'rgba(0, 0, 0, 0.54)'
    export const blackHint: 'rgba(0, 0, 0, 0.38)'
    export const blackTransparent: 'rgba(0, 0, 0, 0)'

    export const whitePrimary: 'rgba(255, 255, 255, 1)'
    export const whiteSecondary: 'rgba(255, 255, 255, 0.70)'
    export const whiteHint: 'rgba(255, 255, 255, 0.50)'
